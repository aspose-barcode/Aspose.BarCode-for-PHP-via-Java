...
class ThriftAsposeBarcodeService_MaxiCodeCodetextMode2_initFromString_args
{
    ...
    {
        return 'ThriftAsposeBarcodeService_MaxiCodeCodetextMode2_initFromString_args';
    }
    ...
    {
        $xfer = 0;
        $xfer += $output->writeStructBegin('ThriftAsposeBarcodeService_MaxiCodeCodetextMode2_initFromString_args');
        if ($this->obj1 !== null) {
