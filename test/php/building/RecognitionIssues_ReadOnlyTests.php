...
class RecognitionIssues_ReadOnlyTests
{
private $_folder;
...
$reader = new BarcodeReader(pathCombine($this->_folder, "Issue34141/datamatrix-B4L7S02-IMG_20150106_150302.jpg"), null, \Aspose\Barcode\DecodeType::DATA_MATRIX);
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33597/TestingDifferentSizes_ReadOnly_74_35x18.png"), null, \Aspose\Barcode\DecodeType::CODE_39);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 0, "false is ok");
        }
    }
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33597/TestingDifferentSizes_ReadOnly_75_36x18.png"), null, \Aspose\Barcode\DecodeType::CODE_39);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 0, "false is ok");
        }
    }
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33597/TestingDifferentSizes_ReadOnly_76_37x18.png"), null, \Aspose\Barcode\DecodeType::CODE_39);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 0, "false is ok");
        }
    }
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33597/TestingDifferentSizes_ReadOnly_77_38x18.png"), null, \Aspose\Barcode\DecodeType::CODE_39);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 0, "false is ok");
        }
    }
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33597/TestingDifferentSizes_ReadOnly_78_39x18.png"), null, \Aspose\Barcode\DecodeType::CODE_39);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 0, "false is ok");
        }
    }
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33597/TestingDifferentSizes_ReadOnly_79_40x18.png"), null, \Aspose\Barcode\DecodeType::CODE_39);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 0, "false is ok");
        }
    }
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33597/TestingDifferentSizes_ReadOnly_80_41x18.png"), null, \Aspose\Barcode\DecodeType::CODE_39);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 0, "false is ok");
        }
    }
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33597/TestingDifferentSizes_ReadOnly_81_42x18.png"), null, \Aspose\Barcode\DecodeType::CODE_39);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 0, "false is ok");
        }
    }
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33597/TestingDifferentSizes_ReadOnly_82_43x18.png"), null, \Aspose\Barcode\DecodeType::CODE_39);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 0, "false is ok");
        }
    }
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33597/TestingDifferentSizes_ReadOnly_83_44x18.png"), null, \Aspose\Barcode\DecodeType::CODE_39);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 0, "false is ok");
        }
    }
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33597/TestingDifferentSizes_ReadOnly_84_45x18.png"), null, \Aspose\Barcode\DecodeType::CODE_39);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 0, "false is ok");
        }
    }
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33597/TestingDifferentSizes_ReadOnly_85_46x18.png"), null, \Aspose\Barcode\DecodeType::CODE_39);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 0, "false is ok");
        }
    }
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33516/SymbologyItem_29_Code39Extended.png"), null, \Aspose\Barcode\DecodeType::CODE_39);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 1);
            Assert::assertEquals("12345", $reader->getFoundBarCodes()[0]->getCodeText("UTF-8"));
        }
...
//    //[Category("Code128")]
//    function test_Issue33572_IMG0convSmall_png_Code128() {
//    $img = pathCombine($this->_folder, "Issue33572/IMG0convSmall.png");
//        $reader = new BarcodeReader($img, new Rectangle(43, 1120, 30, 580), \Aspose\Barcode\DecodeType::CODE_128);
//        {
...
//[Category("Code39Standard")]
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33136/cisco_image4.png"), null, [\Aspose\Barcode\DecodeType::CODE_39, \Aspose\Barcode\DecodeType::CODE_39]);
        {
...
//[Category("Code39Standard")]
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33136/cisco_image2.png"), null, [\Aspose\Barcode\DecodeType::CODE_39, \Aspose\Barcode\DecodeType::CODE_39]);
        {
            $reader->getQualitySettings()->getDetectorSettings()->setRegionLikelihoodThresholdPercent(0.2);
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 2);
...
//[Category("Code39Standard")]
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33136/cisco_image1.png"), null, [\Aspose\Barcode\DecodeType::CODE_39, \Aspose\Barcode\DecodeType::CODE_39]);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 2);
...
//[Category("Code39Standard")]
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33136/cisco_image0.png"), null, [\Aspose\Barcode\DecodeType::CODE_39, \Aspose\Barcode\DecodeType::CODE_39]);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 2);
...
//[Category("Code39Standard")]
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue28448/ga_edit_300dbi.jpg"), null, [\Aspose\Barcode\DecodeType::CODE_39, \Aspose\Barcode\DecodeType::CODE_39]);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 1);
...
//[Category("Code39Standard")]
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue28448/ga_noedit_300dpi.jpg"), null, [\Aspose\Barcode\DecodeType::CODE_39, \Aspose\Barcode\DecodeType::CODE_39]);
        {
            Assert::assertEquals(sizeOf($reader->readBarCodes()), 1);
            Assert::assertEquals("2-CERTIFICATIONS", $reader->getFoundBarCodes()[0]->getCodeText("UTF-8"));
        }
...
//[Category("AllSupportedTypes")]
    ...
    $reader = new BarcodeReader(pathCombine($this->_folder, "Issue33429/Test4.jpg"), null, \Aspose\Barcode\DecodeType::ALL_SUPPORTED_TYPES);
        {
            $reader->setQualitySettings(\Aspose\Barcode\QualitySettings::getMaxQualityDetection());
...
TestsLauncher::launch('\building\RecognitionIssues_ReadOnlyTests', null);
